    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-secondary rounded-xl shadow-lg border border-border/50 p-6">
                <form method="POST" class="grid grid-cols-2 gap-3" action="{{ route('admin.clients.update', $client) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <x-text-input id="name" maxlength="100" class="block mt-1 w-full" type="text" name="name" :value="old('name', $client->name)" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="lastname" maxlength="100" class="block mt-1 w-full" type="text" name="lastname" :value="old('lastname', $client->lastname)" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="username" maxlength="100" class="block mt-1 w-full" type="text" name="username" :value="old('username', $client->username)" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" maxlength="100" class="block mt-1 w-full" type="email" name="email" :value="old('email', $client->email)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="dui" maxlength="10" class="block mt-1 w-full" type="text" name="dui" :value="old('dui', $client->dui)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="birth_date" class="block mt-1 w-full" type="date" name="birth_date" :value="old('birth_date', $client->birth_date ? $client->birth_date->format('Y-m-d') : '')" max="{{ date('Y-m-d', strtotime('-1 day')) }}" />
                        <x-input-error :messages="$errors->get('birth_date')" class="mt-2" />
                    </div>

                    <!-- Password (Optional) -->
                    <div class="col-span-2">
                        <p class="text-sm text-textMuted mb-3">Dejar en blanco si no desea cambiar la contraseña</p>
                    </div>
