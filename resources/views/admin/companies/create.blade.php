    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-secondary rounded-xl shadow-lg border border-border/50 p-6">
                <form method="POST" class="grid grid-cols-2 gap-3" action="{{ route('admin.companies.store') }}">
                    @csrf

                    <!-- Company name -->
                    <div>
                        <x-input-label for="company_name" :value="__('Nombre de la compañía')" />
                        <x-text-input id="company_name" maxlength="255" class="block mt-1 w-full" type="text" name="company_name" :value="old('company_name')" required autofocus autocomplete="company_name" />
                    ...
                    <div>
                        ...
                        <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" required autocomplete="phone" placeholder="0000-0000" />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" maxlength="255" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
                    ...
                    <div class="col-span-2">
                        ...
                        <x-textarea-input id="address" maxlength="255" class="block mt-1 w-full" name="address" required autocomplete="address">{{ old('address') }}</x-textarea-input>
                    ...
                    <div>
                        ...
                        <x-text-input id="password" maxlength="16" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" />
                    ...
                    <div>
                        ...
                        <x-text-input id="password_confirmation" maxlength="16" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" />
