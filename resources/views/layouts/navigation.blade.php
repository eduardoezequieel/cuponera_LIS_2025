            ...
            <nav class="space-y-3">
                ...
                <div class="pt-2">
                    ...
                    <a href="{{ route('admin.companies.index') }}" 
                       class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.companies.*') ? 'bg-primary text-white' : 'text-textMuted hover:bg-border hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.clients.index') }}" 
                       class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.clients.*') ? 'bg-primary text-white' : 'text-textMuted hover:bg-border hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.reports.index') }}" 
                       class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.reports.*') ? 'bg-primary text-white' : 'text-textMuted hover:bg-border hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-2">
                    ...
                    <a href="{{ route('company.coupons.index') }}" 
                       class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('company.coupons.*') ? 'bg-primary text-white' : 'text-textMuted hover:bg-border hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
