    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-secondary rounded-xl shadow-lg border border-border/50 p-6">
                <form method="POST" class="grid grid-cols-2 gap-3" action="{{ route('company.coupons.store') }}">
                    @csrf

                    <!-- Title -->
                    <div class="col-span-2">
                        <x-input-label for="title" value="Título del Cupón" />
                        <x-text-input id="title" maxlength="255" class="block mt-1 w-full" type="text" name="title" :value="old('title')" required autofocus autocomplete="title" />
                    ...
                    <div>
                        ...
                        <x-text-input id="regular_price" class="block mt-1 w-full" type="number" step="0.01" name="regular_price" :value="old('regular_price')" required autocomplete="regular_price" />
                    ...
                    <div>
                        ...
                        <x-text-input id="offer_price" class="block mt-1 w-full" type="number" step="0.01" name="offer_price" :value="old('offer_price')" required autocomplete="offer_price" />
                    ...
                    <div>
                        ...
                        <x-text-input id="redemption_deadline" class="block mt-1 w-full" type="date" name="redemption_deadline" :value="old('redemption_deadline')" required autocomplete="redemption_deadline" />
                    ...
                    <div>
                        ...
                        <x-text-input id="quantity" class="block mt-1 w-full" type="number" name="quantity" :value="old('quantity')" autocomplete="quantity" />
                    ...
                    <div class="col-span-2">
                        ...
                        <x-textarea-input id="description" maxlength="1000" class="block mt-1 w-full" name="description" required autocomplete="description">{{ old('description') }}</x-textarea-input>
