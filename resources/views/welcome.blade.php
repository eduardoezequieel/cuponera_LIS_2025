            ...
            <div class="max-w-4xl w-full">
                <div class="text-center space-y-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
                        <a href="{{ route('client.coupons.index') }}" class="w-full sm:w-auto">
                            <button class="w-full sm:w-auto bg-secondary hover:bg-secondary/90 text-white font-bold py-4 px-8 rounded-xl shadow-lg shadow-secondary/50 hover:shadow-xl hover:shadow-secondary/70 transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-2">
